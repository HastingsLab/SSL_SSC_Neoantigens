...
# Directories
FQ_DIR = "/scratch/eknodel/SCC_samples/cell_lines/Progeny/RNAseq/trimmed_fastqs/" # path to directory with trimmed FASTQ files
SAM_AL_DIR = "/scratch/eknodel/SCC_samples/cell_lines/Progeny/RNAseq/sam/" # path to directory for SAM alignment files
BAM_AL_DIR = "/scratch/eknodel/SCC_samples/cell_lines/Progeny/RNAseq/bam/" # path to directory for BAM alignment files
SORTED_BAM_AL_DIR = "/scratch/eknodel/SCC_samples/cell_lines/Progeny/RNAseq/sorted_bam/" # path to directory for sorted BAM alignment files
