...
rule remove_duplicates:
    ...
    output:
        gatk_filtered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_gatk_vep_filtered_snps.vcf"),
        gatk_unfiltered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_gatk_vep_unfiltered_snps.vcf"),
        strelka_filtered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_strelka_vep_filtered_snps.vcf"),
        strelka_unfiltered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_strelka_vep_unfiltered_snps.vcf")
    params: 
...
rule index_vcf:
    input: 
        ...
        strelka_unfiltered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_strelka_vep_unfiltered_snps.vcf")
    output:
        gatk_filtered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_gatk_vep_filtered_snps.vcf.idx"),
        gatk_unfiltered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_gatk_vep_unfiltered_snps.vcf.idx"),
        strelka_filtered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_strelka_vep_filtered_snps.vcf.idx"),
        strelka_unfiltered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_strelka_vep_unfiltered_snps.vcf.idx")        
    params: 
        gatk = "/home/eknodel/gatk-4.1.7.0/gatk"
    shell:
        """
...
rule gatk_asereadcounter:
    input: 
        ...
        strelka_filtered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_strelka_vep_filtered_snps.vcf"),
        strelka_unfiltered = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_strelka_vep_unfiltered_snps.vcf"),
        gatk_filtered_idx = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_gatk_vep_filtered_snps.vcf.idx"),
        gatk_unfiltered_idx = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_gatk_vep_unfiltered_snps.vcf.idx"),
        strelka_filtered_idx = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_strelka_vep_filtered_snps.vcf.idx"),
        strelka_unfiltered_idx = os.path.join(vep_path, "DNA_483-SC-01-B6_9-3-21_133_060_S138_L002_strelka_vep_unfiltered_snps.vcf.idx")
    output:
