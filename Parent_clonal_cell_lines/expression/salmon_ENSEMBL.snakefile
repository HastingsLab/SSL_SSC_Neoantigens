...
SALMON_INDEX = "/data/CEM/shared/public_data/references/ensemble_GRCm38.68/transcriptome/Mus_musculus_salmon_index_new/"

# Directories
FQ_DIR = "/scratch/eknodel/SCC_samples/Parent_cell_lines/RNAseq/trimmed_fastqs/" # path to directory with trimmed FASTQ files
SALMON_DIR = "/scratch/eknodel/SCC_samples/Parent_cell_lines/RNAseq/salmon_ensembl/" # path to directory for Salmon output files
