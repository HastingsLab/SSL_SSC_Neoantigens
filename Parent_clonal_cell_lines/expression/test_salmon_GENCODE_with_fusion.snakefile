...
# Samples
sample = ["185-1-5c-01-F11-6-26-21-1_216_361_S9_L003"]
#, "188-2-5c-05-F11-6-11-21_203_374_S18_L003", "244-1-chu-06-D12-6-22-21_213_364_S33_L003",
...
SALMON_INDEX = "/scratch/eknodel/SCC_samples/reference/gencode_transcript_gene_fusion_index/"
...
rule all:
    input:
        expand(SALMON_DIR + "{sample}_salmon_quant_fusion/", SALMON_DIR=SALMON_DIR, sample=sample),
...
rule salmon_quant_paired:
    ...
    output:
        OUTPUT = os.path.join(SALMON_DIR, "{sample}_salmon_quant_fusion/"),
    params:
        SALMON = SALMON,
