...
rule remove_duplicates:
    input:    
        gatk_filtered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_gatk_vep_filtered.vcf"),
        gatk_unfiltered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_gatk_vep_unfiltered.vcf"),
        strelka_filtered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_filtered.vcf"),
        strelka_unfiltered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_unfiltered.vcf"),
        ref = "/data/CEM/shared/public_data/references/ensemble_GRCm38.68/GRCm38_68.fa"
    output:
        gatk_filtered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_gatk_vep_filtered_SNP.vcf"),
        gatk_unfiltered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_gatk_vep_unfiltered_SNP.vcf"),
        strelka_filtered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_filtered_SNP.vcf"),
        strelka_unfiltered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_unfiltered_SNP.vcf")
    params: 
...
rule index_vcf:
    input: 
        ...
        strelka_unfiltered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_unfiltered_SNP.vcf")
    output:
        gatk_filtered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_gatk_vep_filtered_SNP.vcf.idx"),
        gatk_unfiltered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_gatk_vep_unfiltered_SNP.vcf.idx"),
        strelka_filtered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_filtered_SNP.vcf.idx"),
        strelka_unfiltered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_unfiltered_SNP.vcf.idx")        
    params: 
        gatk = "/home/eknodel/gatk-4.1.7.0/gatk"
    shell:
        """
...
rule gatk_asereadcounter:
    input: 
        ...
        strelka_filtered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_filtered_SNP.vcf"),
        strelka_unfiltered = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_unfiltered_SNP.vcf"),
        gatk_filtered_idx = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_gatk_vep_filtered_SNP.vcf.idx"),
        gatk_unfiltered_idx = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_gatk_vep_unfiltered_SNP.vcf.idx"),
        strelka_filtered_idx = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_filtered_SNP.vcf.idx"),
        strelka_unfiltered_idx = os.path.join(vep_path, "244_1_Chu_06_F5_328_249_S4_L003_strelka_vep_unfiltered_SNP.vcf.idx")
    output:
